...
exp.addSwitch("s3", dpid=Tools.makeDPID(2), wid=1)
...
exp.addLink("s2", "s3", autoconf=True)
exp.addLink("h5", "s3", autoconf=True)
exp.addLink("h6", "s3", autoconf=True)

time.sleep(2)

print "pinging h1 to h6 to check connectivity of new host..."
# show network connectivity of new hosts
print exp.get("h1").cmd("ping -c2 10.0.0.6")
print exp.get("h1").cmd("ping -c10 10.0.0.6")
#print exp.get("h3").cmd("ping -c5 10.0.0.1")

print "pinging h4 to h6 to check connectivity of new host..."
print exp.get("h4").cmd("ping -c2 10.0.0.6")
print exp.get("h4").cmd("ping -c10 10.0.0.6")
