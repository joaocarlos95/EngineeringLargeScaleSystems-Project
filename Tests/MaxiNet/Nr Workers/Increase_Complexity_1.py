...
topo.addSwitch("s3", dpid=Tools.makeDPID(3), wid=0)
...
topo.addLink("h1", "s5", bw=0.1)
topo.addLink("h2", "s5", bw=0.1)
topo.addLink("h3", "s6", bw=0.1)
topo.addLink("h4", "s6", bw=0.1)
topo.addLink("h5", "s3", bw=0.1)
topo.addLink("h6", "s3", bw=0.1)
topo.addLink("h7", "s4", bw=0.1)
topo.addLink("h8", "s4", bw=0.1)

topo.addLink("s1", "s2", bw=0.1)
topo.addLink("s1", "s5", bw=0.1)
topo.addLink("s1", "s6", bw=0.1)
topo.addLink("s2", "s3", bw=0.1)
topo.addLink("s2", "s4", bw=0.1)
...
print exp.get_node("h8").cmd("iperf -s -u &")

print exp.get_node("h1").cmd("iperf -c 10.0.0.8 -u")
print exp.get_node("h2").cmd("iperf -c 10.0.0.8 -u")
